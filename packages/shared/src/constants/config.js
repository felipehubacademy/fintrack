// Constantes da aplicação compartilhadas entre Web e Mobile
export const APP_CONFIG = {
  ...
  API_URL: 'https://meuazulao.com.br/api',
...
// Função para verificar se está no domínio correto (apenas Web)
...
// Função para redirecionar para o domínio correto (apenas Web)
